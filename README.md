...
- **Mini-jeu caché** : pendant une nuit, **allume la lumière gauche 5 fois très
  vite** → un point doré pulse dans le bureau ; clique-le pour lancer un
  *tape-taupe* (15 points en 30 s = succès secret).
