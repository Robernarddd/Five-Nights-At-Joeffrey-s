...
//   adam (gauche, agressif) · nolan (droite, régulier)
//   celian (Pirate Cove -> gauche, par états) · joeffrey (droite, lent/sournois)
// Rappel des côtés : GAUCHE = adam + celian, DROITE = nolan + joeffrey.
const NIGHTS = [
